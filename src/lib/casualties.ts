...
export const POLICE_SNAPSHOT: CasualtySnapshot = {
  ...
  missing: 5326,
  injured: 7498,
  source: "Dead raised to 1,396 — Nepal Police news/10429 Bhotekoshi flood update (as of Monday 14 September 2026, 20:00 NPT; district bodies Rasuwa 189 + Nuwakot 202 + Dhading 71 + Chitwan 364 + Gorkha 78 + Tanahun 38 + Nawalparasi East 232 + West 222 = 1,396). Missing held 5,326 (police 4,089 / NDRRMA IFRC 5,130 — never lower). Injured held 7,498 (NDRRMA IFRC injured 337 below floor — never lower). IFRC GO 8073 key_figures 1,388/5,130/337 (updated 2026-09-14T02:14:57Z). Wikipedia Nepal-only 1,386/5,130.",
  asOf: "2026-09-14T20:00:00+05:45",
  live: false,
};
