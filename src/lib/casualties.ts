...
export const POLICE_SNAPSHOT: CasualtySnapshot = {
  ...
  missing: 5326,
  injured: 7498,
  source: "Dead raised to 1,385 \u2014 NDRRMA via IFRC GO event 8073 key_figures Confirmed Dead (updated 2026-09-11T08:56:40Z / ~14:41 NPT Friday 11 September). Missing held 5,326 (police ~4,089 / NDRRMA IFRC 5,130 / Wikipedia Nepal-only 5,132 \u2014 never lower). Injured held 7,498 (NDRRMA IFRC injured 337 below floor \u2014 never lower). Nepal Police nepalpolice.gov.np 502 this run; Wikipedia Nepal-only 1,369/5,132/6,827 below.",
  asOf: "2026-09-11T14:41:00+05:45",
  live: false,
};
