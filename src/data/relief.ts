...
export const UPDATED_ON = "12 September 2026";
export const FIGURES_AS_OF = "11 September 2026, 17:00 NPT";
export const FIGURES_SOURCE = "NDRRMA + held floors (Nepal-only)";
export const FIGURES_NOTE =
  "Latest snapshot 11 September 2026, 17:00 NPT. Confirmed dead 1,386, missing 5,326, injured 7,498. Dead raised to 1,386 from NDRRMA Spokesperson Shanti Mahat (myRepublica / Samabeshi Sanchar; includes recovered human remains). Missing held at 5,326 (police ~4,089 / NDRRMA IFRC 5,130 / Wikipedia Nepal-only 5,132 \u2014 never lower). Injured held at 7,498 (NDRRMA IFRC injured 337 below floor). Numbers are still changing.";

export const SHARE_TEXT =
  "Catastrophic flash floods hit Nepal\u2019s Himalayas on 26 August. Official Nepal-only figures: 1,386 deaths, with 5,326 people still missing. Donate only through the official Government of Nepal Prime Minister\u2019s Disaster Relief Fund:\nhttps://pmdrf.nchl.com.np/";

export const stats = [
  { value: "1,386", label: "Confirmed dead" },
