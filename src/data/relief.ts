...
export const UPDATED_ON = "15 September 2026";
export const FIGURES_AS_OF = "15 September 2026, 17:00 NPT";
export const FIGURES_SOURCE = "Nepal Police news/10440 + held floors (Nepal-only)";
export const FIGURES_NOTE =
  "Latest snapshot 15 September 2026, 17:00 NPT. Confirmed dead 1,399, missing 5,326, injured 7,498. Dead raised to 1,399 from Nepal Police news/10440 (Tuesday 17:00 NPT; district body count 1,397 + 2 Kathmandu treatment deaths). Missing held at 5,326 (police 4,089 / NDRRMA IFRC 5,130 \u2014 never lower). Injured held at 7,498 (NDRRMA IFRC injured 337 below floor). Numbers are still changing.";

export const SHARE_TEXT =
  "Catastrophic flash floods hit Nepal\u2019s Himalayas on 26 August. Official Nepal-only figures: 1,399 deaths, with 5,326 people still missing. Donate only through the official Government of Nepal Prime Minister\u2019s Disaster Relief Fund:\nhttps://pmdrf.nchl.com.np/";

export const stats = [
  { value: "1,399", label: "Confirmed dead" },
