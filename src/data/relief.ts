...
export const FIGURES_AS_OF = "30 August 2026, 17:55 NPT";
export const FIGURES_SOURCE = "Nepal Police via BBC / ANI (Nepal-only)";
export const FIGURES_NOTE =
  "Nepal Police via BBC: 788 dead. NDRRMA 2,502 missing (Nepal-only). Injured held at prior official peak (1,473). Counts only move up. Rechecked 30 August, 17:55 NPT.";

export const SHARE_TEXT =
  "Catastrophic flash floods hit Nepal’s Himalayas on 26 August. Official Nepal-only figures: 788 deaths, with 2,502 people still missing. Donate only through the official Government of Nepal Prime Minister’s Disaster Relief Fund:
https://pmdrf.nchl.com.np/";

export const stats = [
  { value: "788", label: "Confirmed dead" },
